                                                     ...
                                                     void *response, size_t *response_size)
{
    ...
    *response_size = sizeof(cxl_ide_km_k_gostop_ack_t);
    ...
    status = cxl_ide_km_device_key_set_go (pci_doe_context, spdm_context, session_id,
