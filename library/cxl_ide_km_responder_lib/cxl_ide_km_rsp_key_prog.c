...
{
    const cxl_ide_km_key_prog_t *ide_km_request;
    cxl_ide_km_kp_ack_t *ide_km_response;
    ...
    *response_size = sizeof(cxl_ide_km_kp_ack_t);

    libspdm_zero_mem (response, *response_size);
    ide_km_response->header.object_id = CXL_IDE_KM_OBJECT_ID_KP_ACK;
    ...
    status = cxl_ide_km_device_key_prog (pci_doe_context, spdm_context, session_id,
    ...
    libspdm_zero_mem ((void *)(ide_km_request + 1), sizeof(cxl_ide_km_aes_256_gcm_key_buffer_t));
