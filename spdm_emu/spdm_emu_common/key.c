...
uint32_t m_use_requester_capability_flags =
    (0 |
     ...
     SPDM_GET_CAPABILITIES_REQUEST_FLAGS_LARGE_RESP_CAP | /* conflict with SPDM_GET_CAPABILITIES_REQUEST_FLAGS_PUB_KEY_ID_CAP */
     0);
uint32_t m_use_responder_capability_flags =
    (0 | SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_CACHE_CAP |
     ...
     SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_LARGE_RESP_CAP | /* conflict with SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_PUB_KEY_ID_CAP */
     0);
 ...
 */
uint32_t m_support_hash_algo = SPDM_ALGORITHMS_BASE_HASH_ALGO_TPM_ALG_SHA_256;
/*
 ...
 */
uint16_t m_support_key_schedule_algo = SPDM_ALGORITHMS_KEY_SCHEDULE_SPDM;
/*
...
uint32_t m_support_kem_algo = SPDM_ALGORITHMS_KEM_ALG_ML_KEM_512 |
                              SPDM_ALGORITHMS_KEM_ALG_ML_KEM_768 |
                              SPDM_ALGORITHMS_KEM_ALG_ML_KEM_1024;
bool m_support_pqc_first = false;
